  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">EduGrove?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than EduGrove, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          As the founder and CEO of EduGrove, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created EduGrove &ndash; to provide new
          ...
          <br />
          <br />
          At EduGrove, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But EduGrove is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With EduGrove by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the EduGrove family today and
        ...
        <br />
        <span className="text-[22px]">Chitkarians&apos;s</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of EduGrove
        </h5>
        <br />
        <br />
        <br />
